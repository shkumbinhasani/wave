...
enum KeychainHelper {
    private static let service = "com.wave.terminal.ssh"
    ...
    static func save(password: String, for account: String) -> Bool {
        ...
        // Be explicit about accessibility rather than relying on the platform
        // default: only readable while the device/Mac is unlocked.
